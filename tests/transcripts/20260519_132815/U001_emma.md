...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:28:15.132Z",
    "last_updated_at": "2026-05-19T10:28:15.132Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u001_savings_transfer_draft_001_create_draft_1779186495132",
    "action_id": "act_u001_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 25/month to Laptop (€1,200). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:28:15.132Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:28:15.133Z",
    "last_updated_at": "2026-05-19T10:28:15.133Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u001_expense_review_habit_001_create_draft_1779186495133",
    "action_id": "act_u001_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:28:15.133Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u001_expense_review_habit_001_approve_1779186495133",
    "action_id": "act_u001_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
