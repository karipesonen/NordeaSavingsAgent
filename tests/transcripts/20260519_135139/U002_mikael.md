...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:51:39.804Z",
    "last_updated_at": "2026-05-19T10:51:39.804Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u002_savings_transfer_draft_001_create_draft_1779187899804",
    "action_id": "act_u002_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Emergency fund + travel. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:51:39.804Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u002_savings_transfer_draft_001_approve_1779187899804",
    "action_id": "act_u002_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_create_draft_1779187899804",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:51:39.804Z",
    "last_updated_at": "2026-05-19T10:51:39.805Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_approve_1779187899805",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
    ...
    "summary": "Approved in demo memory: review subscriptions monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:51:39.805Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
