...
- futurePerspectiveShown: PASS
- futurePerspectiveLimited: PASS
- futurePerspectiveHasOneChoice: PASS
- futurePerspectiveNoEssayPrompt: PASS
- futurePerspectiveNoGuarantees: PASS
...
Based on your current money picture, I would start by checking whether EUR 175/month could be safe without touching essentials. Want me to show the simple monthly table behind that number?
...
Motivation note: I can draft a safe monthly habit for iPhone + travel fund, but I need a target amount before calling the timeline realistic.
...
```json
{
  ...
  "goal_realism": {
    ...
    "timeline_realism": "unknown",
    "motivation_risk": "medium",
    "realism_label": "Needs a target",
    "reason": "No target amount was available, so Nora can draft a safe habit but cannot judge the full timeline yet.",
    "suggested_first_milestone": null,
    "suggested_levers": [
      "add a target amount",
      "set a first milestone",
      "review whether the monthly amount feels worth keeping"
    ],
    "nora_line": "I can draft a safe monthly habit for iPhone + travel fund, but I need a target amount before calling the timeline realistic."
  },
  "levers": [],
...
**Future Perspective**
Future-you view, 12 months from now:
You have EUR 300 saved automatically toward iPhone + travel fund, but the goal is not fully funded yet.
Tradeoff:
Faster needs boosts or a higher amount; calmer needs more time.
Question:
Which feels more like you: faster with boosts, or calmer with a longer timeline?
Options: Faster with boosts | Calmer longer timeline

**Future Perspective Tool**
```json
{
  "agent": "future_perspective_card",
  "status": "available",
  "title": "Future-you view",
  "trigger": "slow_goal_tradeoff",
  "time_horizon": "12 months",
  "future_snapshot": "You have EUR 300 saved automatically toward iPhone + travel fund, but the goal is not fully funded yet.",
  "tradeoff": "Faster needs boosts or a higher amount; calmer needs more time.",
  "decision_question": "Which feels more like you: faster with boosts, or calmer with a longer timeline?",
  "options": [
    "Faster with boosts",
    "Calmer longer timeline"
  ],
  "memory_updates": [
    {
      "field": "recommendation_history",
      "value": {
        "id": "future_perspective_slow_goal_tradeoff",
        "type": "future_perspective",
        "summary": "Future perspective shown for slow goal tradeoff.",
        "trigger": "slow_goal_tradeoff",
        "amount": null,
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.044Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    },
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.044Z",
    "last_updated_at": "2026-05-28T09:47:45.044Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u005_savings_transfer_draft_001_create_draft_1779961665044",
    "action_id": "act_u005_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 25/month to iPhone + travel fund. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.044Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
For iPhone + travel fund, there are two honest routes: keep the monthly amount low, or reach the goal faster. Which would feel more realistic for you right now?
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_create_draft_1779961665044",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
...
Money friend recap: you prefer low-risk, simple steps; your draft is EUR 25/month toward iPhone + travel fund; inspect subscriptions once a month before changing anything.; and investing should stay education-first until risk feels less mysterious.

Want the quick money card on "What investment risk means" now, or should I stop the demo conversation here?
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.044Z",
    "last_updated_at": "2026-05-28T09:47:45.045Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_approve_1779961665045",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: review subscriptions monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.045Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
Quick money card: Risk means movement, not chaos
...
One quick check: What is the first practical question before investing goal money?
...
Small win: You used the risk idea by keeping this journey savings-first before any investment action. (Applied once.) Progress without homework. I will keep Funds as the next useful thing to explain when you are ready.

One useful next thing: If you want one useful next thing, save this article for later: "5 Strategies to Navigate Market Volatility" from Morgan Stanley (5 min). Useful after the user says risk or market drops make investing feel scary.

Want links like this as articles, videos, or podcasts next time?

Money picture: iPhone + travel fund has a draft habit of EUR 25/month. The current habit stack is EUR 25/month plus one monthly subscriptions review. You used the risk idea by keeping this journey savings-first before any investment action.
...
Title: 5 Strategies to Navigate Market Volatility
Format: article
Domain: Risk Without Panic
Source: Morgan Stanley
URL: https://www.morganstanley.com/insights/articles/5-investment-strategies-market-volatility
...
```json
{
  ...
  "status": "available",
  "resource": {
    "id": "risk_article_market_volatility_morgan_stanley_001",
    "title": "5 Strategies to Navigate Market Volatility",
    "format": "article",
    "domain": "Risk Without Panic",
    "topic": "Market volatility and staying calm",
    "source": "Morgan Stanley",
    "url": "https://www.morganstanley.com/insights/articles/5-investment-strategies-market-volatility",
    "estimated_time_minutes": 5,
    "summary": "Explains that market volatility is a normal part of investing and gives practical strategies for handling it without panic."
  },
  "nora_line": "If you want one useful next thing, save this article for later: \"5 Strategies to Navigate Market Volatility\" from Morgan Stanley (5 min). Useful after the user says risk or market drops make investing feel scary.",
  "memory_updates": [
    {
      "field": "recommendation_history",
      "value": {
        "id": "rec_U005_risk_article_market_volatility_morgan_stanley_001",
        "type": "education_resource",
        "resource_id": "risk_article_market_volatility_morgan_stanley_001",
        "summary": "5 Strategies to Navigate Market Volatility",
        "domain": "Risk Without Panic",
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.045Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
