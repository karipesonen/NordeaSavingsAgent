...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:55.984Z",
    "last_updated_at": "2026-05-19T10:26:55.984Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_create_draft_1779186415984",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:55.984Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:55.984Z",
    "last_updated_at": "2026-05-19T10:26:55.986Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_approve_1779186415986",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: EUR 50/month savings draft for Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:55.986Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:55.987Z",
    "last_updated_at": "2026-05-19T10:26:55.987Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_create_draft_1779186415987",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:55.987Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_approve_1779186415987",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
