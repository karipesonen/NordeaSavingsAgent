...
You have EUR 600 saved automatically toward Down payment (€30,000), but EUR 30000 is still a long-game target.
Tradeoff:
The habit is useful, but the full goal still needs a milestone, longer timeline, or shared contribution lever.
Question:
Which feels most useful now: smaller milestone, shared contribution later, or keep this as a starter habit?
...
```json
{
  ...
  "trigger": "milestone_tradeoff",
  "time_horizon": "12 months",
  "future_snapshot": "You have EUR 600 saved automatically toward Down payment (€30,000), but EUR 30000 is still a long-game target.",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        "id": "future_perspective_milestone_tradeoff",
        "type": "future_perspective",
        "summary": "Future perspective shown for milestone tradeoff.",
        "trigger": "milestone_tradeoff",
        "amount": null,
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.010Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    },
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.009Z",
    "last_updated_at": "2026-05-28T09:47:45.009Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_create_draft_1779961665009",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.009Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.009Z",
    "last_updated_at": "2026-05-28T09:47:45.011Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_approve_1779961665011",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: EUR 50/month savings draft for Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.011Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.013Z",
    "last_updated_at": "2026-05-28T09:47:45.013Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_create_draft_1779961665013",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.013Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_approve_1779961665013",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
  ...
  "memory_updates": [
    {
      "field": "recommendation_history",
      "value": {
        "id": "rec_U003_starting_safely_article_emergency_fund_cfpb_001",
        ...
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.014Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
