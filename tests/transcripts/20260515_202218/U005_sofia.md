...
```json
{
  ...
  "action": {
    ...
    "summary": "Draft EUR 25/monthly to iPhone + travel fund. Not executed.",
    "amount": 25,
    "currency": "EUR",
    "cadence": "monthly",
    "goal_id": "U005-iphone-travel-fund",
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-15T17:22:18.277Z",
    "last_updated_at": "2026-05-15T17:22:18.277Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u005_savings_transfer_draft_001_create_draft_1778865738277",
    "action_id": "act_u005_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 25/monthly to iPhone + travel fund. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-15T17:22:18.277Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-15T17:22:18.278Z",
    "last_updated_at": "2026-05-15T17:22:18.278Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_create_draft_1778865738278",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-15T17:22:18.278Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_approve_1778865738278",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
