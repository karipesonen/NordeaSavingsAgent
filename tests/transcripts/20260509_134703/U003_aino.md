...
```json
{
  "title": "Start a monthly habit for Down payment (€30,000)",
...
```json
{
  "title": "Approved draft for Down payment (€30,000)",
...
|---|---:|---:|
| Gentle | EUR 50/month | about 600 months |
| Faster | EUR 100/month | about 300 months |
...
```json
{
  "title": "Draft plan options for Down payment (€30,000)",
...
Nora summary so far: you prefer low-risk, visible reasoning; your draft is EUR 50/month toward Down payment (€30,000); and investing should stay education-first until risk feels less mysterious.
