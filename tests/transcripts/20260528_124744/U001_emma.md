...
You have EUR 300 saved automatically toward Laptop (€1,200), but the goal is not fully funded yet.
Tradeoff:
...
```json
{
  ...
  "future_snapshot": "You have EUR 300 saved automatically toward Laptop (€1,200), but the goal is not fully funded yet.",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        ...
        "amount": null,
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.032Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    },
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.032Z",
    "last_updated_at": "2026-05-28T09:47:45.032Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u001_savings_transfer_draft_001_create_draft_1779961665032",
    "action_id": "act_u001_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 25/month to Laptop (€1,200). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.032Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.033Z",
    "last_updated_at": "2026-05-28T09:47:45.033Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u001_expense_review_habit_001_create_draft_1779961665033",
    "action_id": "act_u001_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.033Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u001_expense_review_habit_001_approve_1779961665033",
    "action_id": "act_u001_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
