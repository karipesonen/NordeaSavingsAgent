"""
daily_recap_agent.py
────────────────────
LLM-based daily financial health monitor.
Runs every day at 18:00, reads the user's financial data, memorises spending
patterns from the last 30 days, and produces a green / yellow / red assessment.
Also searches the web for:
  - investment goals  → relevant news that could affect the asset
  - electronics goals → current price discounts / deals
Result stored in data/daily_brief.json.
"""
