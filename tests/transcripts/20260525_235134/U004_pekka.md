...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.592Z",
    "last_updated_at": "2026-05-25T20:51:34.592Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_savings_transfer_draft_001_create_draft_1779742294592",
    "action_id": "act_u004_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Retirement fund + cabin. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.592Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.593Z",
    "last_updated_at": "2026-05-25T20:51:34.593Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_create_draft_1779742294593",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for insurance. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.593Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.593Z",
    "last_updated_at": "2026-05-25T20:51:34.594Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_approve_1779742294594",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: review insurance monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.594Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        "id": "rec_U004_money_habits_article_dca_investors_podcast_001",
        ...
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-25T20:51:34.594Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
