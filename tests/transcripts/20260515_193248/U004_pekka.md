...
Small snapshot: Retirement fund + cabin has a draft habit of EUR 50/month toward EUR 0. The current habit stack is EUR 50/month plus one monthly subscriptions review. You used Why small first amounts can matter once in a real money decision.

Next useful move: Explain Funds next. The user has applied the first confidence step and has a natural next learning path.
...
```json
{
  ...
  "snapshot_card": {
    ...
    "summary": "Retirement fund + cabin has a draft habit of EUR 50/month toward EUR 0. The current habit stack is EUR 50/month plus one monthly subscriptions review. You used Why small first amounts can matter once in a real money decision.",
    "money_state": {
    ...
    "goal_state": {
      ...
      "monthly_contribution": 50,
      "status": "draft",
      "summary": "Retirement fund + cabin has a draft habit of EUR 50/month toward EUR 0."
    },
    "habit_state": {
  ...
  "next_best_action": {
    ...
    "reason": "The user has applied the first confidence step and has a natural next learning path.",
