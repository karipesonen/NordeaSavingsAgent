...
Small snapshot: iPhone + travel fund has a draft habit of EUR 25/month toward EUR 0. The current habit stack is EUR 25/month plus one monthly subscriptions review. You used the risk idea by keeping this journey savings-first before any investment action.
...
```json
{
  ...
  "snapshot_card": {
    ...
    "summary": "iPhone + travel fund has a draft habit of EUR 25/month toward EUR 0. The current habit stack is EUR 25/month plus one monthly subscriptions review. You used the risk idea by keeping this journey savings-first before any investment action.",
    "money_state": {
    ...
    "goal_state": {
      ...
      "monthly_contribution": 25,
      "status": "draft",
      "summary": "iPhone + travel fund has a draft habit of EUR 25/month toward EUR 0."
    },
    "habit_state": {
