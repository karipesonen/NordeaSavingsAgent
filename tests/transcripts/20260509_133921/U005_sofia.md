...
|---|---:|---|
| Gentle | EUR 25/month | You want this to feel almost boring |
| Faster | EUR 50/month | You want more momentum but still stay below the safe-to-save estimate |
...
```json
{
  "title": "Draft plan options for iPhone + travel fund",
  "summary": "Gentle: EUR 25/month. Faster: EUR 50/month. No investment action yet.",
  "amount": 25,
  "currency": "EUR",
  "cadence": "monthly",
  "status": "draft_requires_approval"
...
|---|---:|---|
| Housing | EUR 660/month | monthly |
| Transport | EUR 70/month | monthly |
...
Nora summary so far: you prefer low-risk, visible reasoning; your draft is EUR 25/month toward iPhone + travel fund; and investing should stay education-first until risk feels less mysterious.
