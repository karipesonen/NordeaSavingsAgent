...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:56.018Z",
    "last_updated_at": "2026-05-19T10:26:56.018Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u005_savings_transfer_draft_001_create_draft_1779186416018",
    "action_id": "act_u005_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 25/month to iPhone + travel fund. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:56.018Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:56.019Z",
    "last_updated_at": "2026-05-19T10:26:56.019Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_create_draft_1779186416019",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:56.019Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:26:56.019Z",
    "last_updated_at": "2026-05-19T10:26:56.020Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u005_expense_review_habit_001_approve_1779186416020",
    "action_id": "act_u005_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: review subscriptions monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:26:56.020Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
