...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:27:39.026Z",
    "last_updated_at": "2026-05-19T10:27:39.026Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_savings_transfer_draft_001_create_draft_1779186459026",
    "action_id": "act_u004_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Retirement fund + cabin. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:27:39.026Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_create_draft_1779186459026",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T10:27:39.026Z",
    "last_updated_at": "2026-05-19T10:27:39.027Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_approve_1779186459027",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: review insurance monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T10:27:39.027Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "domain": "Money Habits",
  "domain_key": "money_habits",
  "topic": "Why small first amounts can matter",
  "internal_status": "seen",
  "visible_status": "Started",
  "progress_delta": 25,
  "domain_progress": 25,
  "next_domain_suggestion": "Goal Planning",
  "interested_domains": [],
  "user_facing_summary": "Money Habits is started. Next useful idea later: Goal Planning.",
  "memory_updates": [
    {
    ...
    {
      "field": "learning_progress.domains.money_habits",
      "value": {
        "name": "Money Habits",
        "stage": "money_confidence",
        "status": "seen",
    ...
    },
    {
      ...
      "value": [
        "Money Habits:Why small first amounts can matter:seen"
      ],
      "source": "inferred_from_conversation",
      "confidence": "medium"
    },
