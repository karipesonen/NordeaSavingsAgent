...
```json
{
  ...
  "action": {
    ...
    "summary": "Draft EUR 50/monthly to Emergency fund + travel. Not executed.",
    "amount": 50,
    "currency": "EUR",
    "cadence": "monthly",
    "goal_id": "U002-emergency-fund-travel",
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-15T17:22:18.271Z",
    "last_updated_at": "2026-05-15T17:22:18.271Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u002_savings_transfer_draft_001_create_draft_1778865738271",
    "action_id": "act_u002_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/monthly to Emergency fund + travel. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-15T17:22:18.271Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
For Emergency fund + travel, future-you has two possible preferences: keep the monthly amount low, or reach the goal faster. Which would feel more realistic for you right now?
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-15T17:22:18.272Z",
    "last_updated_at": "2026-05-15T17:22:18.272Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_create_draft_1778865738272",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-15T17:22:18.272Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_approve_1778865738272",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
