...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:52:20.430Z",
    "last_updated_at": "2026-05-25T20:52:20.430Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u002_savings_transfer_draft_001_create_draft_1779742340430",
    "action_id": "act_u002_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Emergency fund + travel. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:52:20.430Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:52:20.430Z",
    "last_updated_at": "2026-05-25T20:52:20.431Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u002_savings_transfer_draft_001_approve_1779742340431",
    "action_id": "act_u002_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: EUR 50/month savings draft for Emergency fund + travel. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:52:20.431Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:52:20.431Z",
    "last_updated_at": "2026-05-25T20:52:20.431Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_create_draft_1779742340431",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
...
```json
{
  ...
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u002_expense_review_habit_001_approve_1779742340431",
    "action_id": "act_u002_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        ...
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-25T20:52:20.432Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
