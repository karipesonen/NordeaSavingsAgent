...
const __TWEAKS_STYLE = `
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    ...
    box-shadow:0 1px 0 rgba(255,255,255,.6) inset,0 8px 24px rgba(0,0,0,.18);
    font:12px/1 ui-sans-serif,system-ui,-apple-system,sans-serif;font-weight:700;
    cursor:pointer}
  .twk-fab:hover{background:rgba(255,255,255,.96)}
  .twk-fab-dot{width:7px;height:7px;border-radius:999px;background:#0000a0;
    box-shadow:0 0 0 3px rgba(0,0,160,.12)}
...
function TweaksPanel({ title = 'Tweaks', children }) {
  ...
  return (
    <>
      ...
      {!open && (
        <button className="twk-fab" type="button" onClick={openPanel} aria-label="Open tweaks">
