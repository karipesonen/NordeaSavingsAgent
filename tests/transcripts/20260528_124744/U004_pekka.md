...
**Future Perspective**
Future-you view, 3 months from now:
You have EUR 150 saved if this small habit runs for three normal months.
Tradeoff:
Approving makes the habit concrete; editing keeps control if the amount feels tight.
Question:
Want to approve the small habit, edit the amount, or leave it parked?
...
```json
{
  ...
  "trigger": "action_approval",
  "time_horizon": "3 months",
  "future_snapshot": "You have EUR 150 saved if this small habit runs for three normal months.",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        "id": "future_perspective_action_approval",
        "type": "future_perspective",
        "summary": "Future perspective shown for action approval.",
        "trigger": "action_approval",
        "amount": null,
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.026Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    },
...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.025Z",
    "last_updated_at": "2026-05-28T09:47:45.025Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_savings_transfer_draft_001_create_draft_1779961665025",
    "action_id": "act_u004_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Retirement fund + cabin. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.025Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.026Z",
    "last_updated_at": "2026-05-28T09:47:45.026Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_create_draft_1779961665026",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for insurance. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.026Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-28T09:47:45.026Z",
    "last_updated_at": "2026-05-28T09:47:45.027Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_approve_1779961665027",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: review insurance monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-28T09:47:45.027Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        ...
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-28T09:47:45.027Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
