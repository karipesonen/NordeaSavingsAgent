...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.578Z",
    "last_updated_at": "2026-05-25T20:51:34.578Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_create_draft_1779742294578",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.578Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.578Z",
    "last_updated_at": "2026-05-25T20:51:34.580Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_approve_1779742294580",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: EUR 50/month savings draft for Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.580Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.581Z",
    "last_updated_at": "2026-05-25T20:51:34.581Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_create_draft_1779742294581",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.581Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:51:34.581Z",
    "last_updated_at": "2026-05-25T20:51:34.582Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_approve_1779742294582",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
    ...
    "summary": "Approved in demo memory: review subscriptions monthly. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:51:34.582Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
One useful next thing: If you want one useful next thing, save this article for later: "The psychology of saving: How to stay motivated on your financial journey" from Business Money (5 min). Useful when a goal is safe but motivation-risk is high and Nora suggests a first milestone.
...
Title: The psychology of saving: How to stay motivated on your financial journey
Format: article
Domain: Goal Planning
Source: Business Money
URL: https://www.business-money.com/announcements/how-to-stay-motivated-on-your-financial-journey/
...
```json
{
  ...
  "status": "available",
  "resource": {
    "id": "goal_planning_article_motivation_business_money_001",
    "title": "The psychology of saving: How to stay motivated on your financial journey",
    "format": "article",
    "domain": "Goal Planning",
    "topic": "Motivation and savings behavior",
    "source": "Business Money",
    "url": "https://www.business-money.com/announcements/how-to-stay-motivated-on-your-financial-journey/",
    "estimated_time_minutes": 5,
    "summary": "Covers money mindset, emotional triggers, smaller milestones, automation, visual progress, and making future rewards feel tangible."
  },
  "nora_line": "If you want one useful next thing, save this article for later: \"The psychology of saving: How to stay motivated on your financial journey\" from Business Money (5 min). Useful when a goal is safe but motivation-risk is high and Nora suggests a first milestone.",
  "memory_updates": [
    {
      "field": "recommendation_history",
      "value": {
        "id": "rec_U003_goal_planning_article_motivation_business_money_001",
        "type": "education_resource",
        "resource_id": "goal_planning_article_motivation_business_money_001",
        "summary": "The psychology of saving: How to stay motivated on your financial journey",
        "domain": "Goal Planning",
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-25T20:51:34.583Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
