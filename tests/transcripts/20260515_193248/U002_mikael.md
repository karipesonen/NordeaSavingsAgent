...
Small snapshot: Emergency fund + travel has a draft habit of EUR 50/month toward EUR 0. The current habit stack is EUR 50/month plus one monthly subscriptions review. You used Why small first amounts can matter once in a real money decision.
...
```json
{
  ...
  "snapshot_card": {
    ...
    "summary": "Emergency fund + travel has a draft habit of EUR 50/month toward EUR 0. The current habit stack is EUR 50/month plus one monthly subscriptions review. You used Why small first amounts can matter once in a real money decision.",
    "money_state": {
    ...
    "goal_state": {
      ...
      "monthly_contribution": 50,
      "status": "draft",
      "summary": "Emergency fund + travel has a draft habit of EUR 50/month toward EUR 0."
    },
    "habit_state": {
