...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T11:21:10.664Z",
    "last_updated_at": "2026-05-19T11:21:10.664Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_create_draft_1779189670664",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T11:21:10.664Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T11:21:10.664Z",
    "last_updated_at": "2026-05-19T11:21:10.665Z"
  },
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_savings_transfer_draft_001_approve_1779189670665",
    "action_id": "act_u003_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "approve",
    ...
    "summary": "Approved in demo memory: EUR 50/month savings draft for Down payment (€30,000). Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T11:21:10.665Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-19T11:21:10.667Z",
    "last_updated_at": "2026-05-19T11:21:10.667Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_create_draft_1779189670667",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for subscriptions. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-19T11:21:10.667Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "approval_request": null,
  "action_log_event": {
    "event_id": "act_u003_expense_review_habit_001_approve_1779189670667",
    "action_id": "act_u003_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
    "from_status": "pending_approval",
