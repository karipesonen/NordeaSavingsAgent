...
```json
{
  ...
  "action": {
    ...
    "approval_required": true,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:54:59.762Z",
    "last_updated_at": "2026-05-25T20:54:59.762Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_savings_transfer_draft_001_create_draft_1779742499762",
    "action_id": "act_u004_savings_transfer_draft_001",
    "action_type": "savings_transfer_draft",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft EUR 50/month to Retirement fund + cabin. Not executed.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:54:59.762Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action": {
    ...
    "approval_required": false,
    "execution_mode": "demo_memory_only",
    "created_at": "2026-05-25T20:54:59.763Z",
    "last_updated_at": "2026-05-25T20:54:59.763Z"
  },
  "approval_request": {
  ...
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_create_draft_1779742499763",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "create_draft",
    "from_status": null,
    ...
    "summary": "Draft a monthly review habit for insurance. No cancellation happened.",
    "execution_mode": "demo_memory_only",
    "timestamp": "2026-05-25T20:54:59.763Z"
  },
  "memory_updates": [
    {
      "field": "action_state",
...
```json
{
  ...
  "action_log_event": {
    "event_id": "act_u004_expense_review_habit_001_approve_1779742499763",
    "action_id": "act_u004_expense_review_habit_001",
    "action_type": "expense_review_habit",
    "operation": "approve",
  ...
  "memory_updates": [
    {
      ...
      "value": {
        ...
        "format": "article",
        "status": "suggested",
        "created_at": "2026-05-25T20:54:59.764Z"
      },
      "source": "inferred_from_conversation",
      "confidence": "medium"
    }
